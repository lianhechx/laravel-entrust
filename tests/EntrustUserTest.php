...
use Opbol\Entrust\Contracts\EntrustUserInterface;
use Opbol\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use Opbol\Entrust\Permission;
use Opbol\Entrust\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('Opbol\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('Opbol\Entrust\Role');
